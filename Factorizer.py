...
class Factorizer:
	...
	def iterative_factorization(self, number):
		factors = []
		# A function to find the smallest factor
		...
		while number > 1:
			smallest_fact = smallest_factor(number)
			factors.append(smallest_fact)
			number //= smallest_fact
